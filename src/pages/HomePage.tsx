...
import { 
  ...
  ArrowRight, Flame, TrendingUp as TrendingIcon
} from 'lucide-react'
...
const HomePage: React.FC = () => {
  ...
  useEffect(() => {
    if (posts.length > 0) {
      // Get trending posts (most viewed/liked)
  ...
  const categories = [
    ...
    { id: 'Backend', label: 'Backend', icon: <TrendingIcon className="h-4 w-4" /> },
  ]
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-background to-secondary/10 py-20">
        <div className="absolute inset-0 bg-grid-white/10 bg-grid mask-gradient" />
        <div className="container relative mx-auto px-4 text-center">
          <Badge className="mb-4 animate-pulse-glow bg-gradient-to-r from-primary to-purple-600">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button 
              size="lg" 
              className="gap-2 animate-bounce-in bg-gradient-to-r from-primary to-purple-600 hover:shadow-xl"
              ...
              >
                <CardHeader className="p-0">
                  <div className="relative h-48 overflow-hidden rounded-t-lg">
                    <img
                      src={post.featuredImage || `https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=800&q=80&auto=format&fit=crop`}
                      alt={post.title}
                ...
                <CardFooter className="p-6 pt-0">
                  <Button className="w-full" onClick={() => navigate(`/blog/${post.id}`)}>
                    Read Story
          ...
          <TabsContent value="trending">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {trendingPosts.map((post, index) => (
                <Card key={post.id} className="group hover:shadow-xl transition-all">
                  <div className="flex flex-col md:flex-row">
                    <div className="md:w-1/3 relative">
                      <img
                        src={post.featuredImage || `https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=400&q=80`}
                        alt={post.title}
